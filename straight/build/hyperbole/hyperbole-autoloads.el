...
Call `org-meta-return' with the numeric value of any prefix arg when given." t)
...
Prompt for the search pattern." t)
...
(fn &optional FORCE-INIT-FLAG)" t)
(make-obsolete 'hyrolo-initialize-file-list 'nil "8.0.1")
...
(fn EXPR &optional COUNT-ONLY INCLUDE-SUB-ENTRIES NO-SUB-ENTRIES-OUT WHOLE-BUFFER-FLAG)" t)
